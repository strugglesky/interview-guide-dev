package org.example.modules.knowledgebase.repository;
...
public interface RagChatSessionRepository extends JpaRepository<RagChatSessionEntity, Long> {
     ...
     * 按更新时间倒序获取所有活跃会话
     */
    List<RagChatSessionEntity> findByStatusOrderByUpdatedAtDesc(RagChatSessionEntity.SessionStatus status);
